...
if ENV["WEBKIT"]
  system("rm public/*_compiled_webkit_*.js")
elsif ENV["GECKO"]
  system("rm public/*_compiled_gecko_*.js")
else
...
if ENV["WEBKIT"]
  cmd_arr << "--define goog.userAgent.ASSUME_WEBKIT=true"
end

if ENV["GECKO"]
  cmd_arr << "--define goog.userAgent.ASSUME_GECKO=true"
end
